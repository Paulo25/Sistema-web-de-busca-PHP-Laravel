            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                           class="emailUser form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                        ...
                        <a href="{{route('password.reset')}}" class="password-reset">
                            Esqueci minha senha
                        </a>
                        {{--<form class="password-reset" action="{{route('password.reset')}}" method="post" >--}}
                        {{--@csrf--}}
